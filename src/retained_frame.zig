...
fn mapCell(src: frame_state.Cell, theme: vt_state.FrameTheme) render_batch.CellInput {
    return .{
        ...
        .underline_color = if (src.attrs.underline_color_set) colorToRgba8(src.underline_color, true, theme) else .{ .r = 0, .g = 0, .b = 0, .a = 0 },
        .underline_style = switch (src.underline_style) {
            .straight => .straight,
            .double => .double,
            .curly => .curly,
            .dotted => .dotted,
