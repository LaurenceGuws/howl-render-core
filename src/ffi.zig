...
pub fn runtimeHasPendingPublication(handle: RuntimeHandle) callconv(.c) u8 {
    const owner = runtimeOwnerFromHandle(handle) orelse return 0;
    return if (owner.runtime.hasPendingPublication()) 1 else 0;
}
