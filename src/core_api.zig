//! Responsibility: export the renderer core API surface.
//! Ownership: shared renderer-core API for selected backends.
//! Reason: keep backend implementations on one local core contract.
