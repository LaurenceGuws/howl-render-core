//! Responsibility: export the unified renderer OpenGL ES backend surface.
//! Ownership: internal backend boundary for the OpenGL ES implementation.
//! Reason: keep root exports boring and push implementation behind a sibling owner file.

const api = @import("RenderGles.zig");

/// Canonical OpenGL ES backend owner surface.
pub const RenderGles = api.RenderGles;
/// Concrete OpenGL ES backend implementation.
pub const Backend = api.Backend;
/// OpenGL ES backend error surface.
